...
export function HowItWorksSection() {
  return (
    ...
    >
      ...
      <div className="space-y-16 lg:space-y-24">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6">
            ...
            <h4 className="text-xl sm:text-2xl lg:text-3xl font-medium text-white leading-tight">
          ...
          <div className="bg-black/20 border border-white/10 overflow-hidden mt-8 lg:mt-0">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:order-1 bg-black/20 border border-white/10 p-4 sm:p-6 mt-8 lg:mt-0">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="bg-black/20 border border-white/10 p-4 sm:p-6 mt-8 lg:mt-0">
            ...
            <div className="space-y-2">
              ...
              {[
                ...
                <div
                  key={i}
                  className="flex items-start sm:items-center justify-between text-xs bg-white/5 p-3 sm:p-2 gap-2"
                >
      ...
      {/* Bottom CTA */}
      <div className="text-center mt-12 lg:mt-20 space-y-6">
