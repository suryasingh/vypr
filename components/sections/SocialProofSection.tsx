      ...
      <div className="grid lg:grid-cols-2 gap-12">
        <div className="bg-white/[0.01] border border-white/5 p-8">
          <blockquote className="text-lg text-gray-300 leading-relaxed">
            ...
            Merchant of Record - it&apos;s like having a global tax team without
            the overhead.&rdquo;
          </blockquote>
        ...
        <div className="bg-white/[0.01] border border-white/5 p-8">
          <blockquote className="text-lg text-gray-300 leading-relaxed">
            ...
            - all without writing a single line of growth code.&rdquo;
          </blockquote>
          <div className="flex items-center space-x-4 mt-6">
            ...
            <div>
              ...
              <div className="text-sm text-gray-400">CTO, SaaS Platform</div>
